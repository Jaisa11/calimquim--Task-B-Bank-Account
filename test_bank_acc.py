...
def check(number, description, expected, produce):
    ...
    try:
        ...
        report(number, "ERROR", description,
    ...
    if str(actual) == str(expected):
        ...
        report(number, "FAIL", description,
...
check(
    1,
    "a new account keeps its opening balance",
    1000,
...
check(
    2,
    "depositing 500 into 1000 gives 1500",
    1500,
    after_deposit
)
...
check(
    3,
    "withdrawing 250 from 1000 gives 750",
    750,
    after_withdraw
)
...
check(
    4,
    "the account prints owner and balance",
    "Juan: 1500.00",
...
print(
    "The balance never went below zero, and no test reached into _balance "
